...
public class pruebaTabla extends javax.swing.JFrame {
    ...
    DefaultTableCellRenderer render = new DefaultTableCellRenderer() {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (value instanceof JCheckBox) {
                ...
                if(isSelected && ch.isSelected() == true){
                    ch.setSelected(false);
                }else if(isSelected && ch.isSelected() == false){
                    ch.setSelected(true);
                }
                return ch;
            }
    ...
    boolean[] valores = {false, false, true, false, false,false};

    DefaultTableModel modelo = new DefaultTableModel() {
        @Override
        public boolean isCellEditable(int row, int column) {
            return valores[column];
        }
    ...
    public pruebaTabla() {
        ...
        modelo.addColumn("Boton");
        modelo.addColumn("Valor");
        modelo.addColumn("combo");
        initComponents();
        jTable1.setDefaultRenderer(Object.class, render);
        modelo.addRow(new Object[]{"Jorge", "Lopes", "34", new JButton("Presioname"), new JCheckBox(),new JComboBox<Object>(new String[]{"a","e"})});
