 ...
 * @author berli
 */
public class ModuloEntregas extends javax.swing.JDialog {

    DefaultComboBoxModel modelo = new DefaultComboBoxModel();
    ConfiguracionPrestamos conf;
    Usuario u;

    public ModuloEntregas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModuloEntregas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModuloEntregas dialog = new ModuloEntregas(new javax.swing.JFrame(), true);
    ...
    private void funcionalidadBotonBuscar() {
        int idCobrador = ((Cobrador) comboCobradores.getSelectedItem()).getIdCobrador();
        long fecha = fechaDeEntregas.getDate().getTime();
        List<Entrega> listaDeEntregas = Bd.buscarEntregas(idCobrador, fecha);

        if (!listaDeEntregas.isEmpty()) {
            System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s %n",
                    "Cliente-Prestamo", "total a pagar", "cuota", "Balance", "monto prestado", "Nombre");

            listaDeEntregas.forEach(entrega -> {
                System.out.printf("%-20s %-20s %-20s %-20s %-20s %-20s %n",
                        entrega.getCodigo(),
                        entrega.getTotalAPagarFormateado(),
                        entrega.getCuotaFormateada(),
                        entrega.getBalanceFormateado(),
                        entrega.getMontoPrestadoFormateado(),
                        entrega.getNombreApellido());
            });
        } else {
    ...
    private void generarReporte() {
            ...
            Reportes.reporteEntregaA4(idCobrador, fecha,this);   
    }
