 ...
 * @author berli
 */
public class ModuloListaDeCobro extends javax.swing.JDialog {

    DefaultComboBoxModel modelo = new DefaultComboBoxModel();
    ConfiguracionPrestamos conf;
    Usuario u;

    public ModuloListaDeCobro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        fechaDeReportes = new com.toedter.calendar.JDateChooser();
        ...
        fechaDeReportes.setDate(new Date());
        fechaDeReportes.setDateFormatString("dd/MM/yyyy");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(fechaDeReportes, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jLabel2.setText("Lista de Cobro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModuloListaDeCobro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModuloListaDeCobro dialog = new ModuloListaDeCobro(new javax.swing.JFrame(), true);
    ...
    private com.toedter.calendar.JDateChooser fechaDeReportes;
    ...
    private void generarReporte() {
        ...
        long fecha = fechaDeReportes.getDate().getTime();

        Reportes.reporteListaDeCobroA4(idCobrador, fecha, this);
    }
    
    private void personalizarDateChoose(){
       JTextFieldDateEditor f = (JTextFieldDateEditor) fechaDeReportes.getDateEditor();
       f.setFocusable(false);
       fechaDeReportes.setLocale(new Locale("Es"));
       fechaDeReportes.setDateFormatString("dd/MM/yyyy");
    }
